...
struct idSWFTextInstance {
	...
	// Offset: 0xD4 (212d) Size: 0x19C (412d)
	char pad_End[412];
}; // size: 0x270 (Size Dec: 624)
static_assert(sizeof(idSWFTextInstance) == 624, "Size of idSWFTextInstance is wrong !");
...
struct idActor {
	// Offset: 0x0 (0d) Size: 0x2820 (10272d)
	char pad_0[10272];
	// Offset: 0x2820 (10272d)  Size: 0x1 (1d)	shared demon / player states
	bool pinged;
	// Offset: 0x2821 (10273d) Size: 0xdb7 (3511d)
	char pad_10273[3511];
	// Offset: 0x35D8 (13784d)  Size: 0x568 (1384d)	everything the actor is holding
	idInventoryCollection inventory;
	// Offset: 0x3b40 (15168d) Size: 0x1010 (4112d)
	char pad_15168[4112];
	// Offset: 0x4B50 (19280d)  Size: 0x4 (4d)
	float overdrivePoints;
	// Offset: 0x4b54 (19284d) Size: 0x7c (124d)
	char pad_19284[124];
	// Offset: 0x4BD0 (19408d)  Size: 0x8 (8d)    (idTypesafeTime < long long , gameTimeUnique_t , 999960 >)
	long long lastTeleportTime;
}; // size: 0x4bd8 (Size Dec: 19416)
static_assert(sizeof(idActor) == 19416, "Size of idActor is wrong !");


// idGK_UpgradeHandler : idUpgradeHandler
struct idGK_UpgradeHandler {
	// Offset: 0x0 (0d) Size: 0x138 (312d)
	char pad_0[312];
	// Offset: 0x138 (312d)  Size: 0x4 (4d)	increases by some fractional amount for each GK -- can only be used when >= 1.0f
	float bloodPunchChargePercent;
	// Offset: 0x13c (316d) Size: 0x44 (68d)
	char pad_316[68];
	// Offset: 0x180 (384d)  Size: 0x4 (4d)
	fxCondition_t fxBloodPunchAOE;
	// Offset: 0x184 (388d) Size: 0x5 (5d)
	char pad_388[5];
	// Offset: 0x189 (393d)  Size: 0x1 (1d)
	bool bloodPunchSuperChargedSoundActivated;
	// Offset: 0x18A (394d) Size: 0x6 (6d)
	char pad_End[6];
}; // size: 0x190 (Size Dec: 400)
static_assert(sizeof(idGK_UpgradeHandler) == 400, "Size of idGK_UpgradeHandler is wrong !");


// idPlayerDashboard : idDamageCompiler_Listener
struct idPlayerDashboard {
	// Offset: 0x0 (0d) Size: 0xf148 (61768d)
	char pad_0[61768];
	// Offset: 0xF148 (61768d)  Size: 0x190 (400d)	Handler for the player upgrades.
	idGK_UpgradeHandler GKUpgrades;
	// Offset: 0xF2D8 (62168d) Size: 0x740 (1856d)
	char pad_End[1856];
}; // size: 0xfa18 (Size Dec: 64024)
static_assert(sizeof(idPlayerDashboard) == 64024, "Size of idPlayerDashboard is wrong !");
...
struct idPlayer {
	// Offset: 0x0 (0d) Size: 0x6f38 (28472d)
	char pad_0[28472];
	// Offset: 0x6F38 (28472d)  Size: 0x8 (8d)	the last delay that was used for mixed mode    (idTypesafeTime < long long , gameTimeUnique_t , 999960 >)
	long long lastDelay;
	// Offset: 0x6F40 (28480d)  Size: 0x4 (4d)	How long the global cooldown takes.    (idTypesafeTime < int , millisecondUnique_t , 1000 >)
	int globalCooldownTimeMS;
	// Offset: 0x6f44 (28484d) Size: 0x4 (4d)
	char pad_28484[4];
	// Offset: 0x6F48 (28488d)  Size: 0xD8 (216d)	------------------------ Equipment ------------------------
	idPlayer_equipmentInfo_t equipmentInfo;
	// Offset: 0x7020 (28704d) Size: 0x3f0 (1008d)
	char pad_28704[1008];
	// Offset: 0x7410 (29712d)  Size: 0x1 (1d)	whether the player wants zoom or not
	bool wantZoom;
	// Offset: 0x7411 (29713d) Size: 0x1094 (4244d)
	char pad_29713[4244];
	// Offset: 0x84A5 (33957d)  Size: 0x1 (1d)	TODO: replace this concept and do this through HUD state instead; this is a temporary fix for beta.
	bool hideReticle;
	// Offset: 0x84A6 (33958d)  Size: 0x1 (1d)	TODO: replace this concept and do this through HUD state instead; this is a temporary fix for beta.
	bool hideHudForCinematic;
	// Offset: 0x84a7 (33959d) Size: 0x209 (521d)
	char pad_33959[521];
	// Offset: 0x86B0 (34480d)  Size: 0x1 (1d)
	bool contextOptionSelected;
	// Offset: 0x86b1 (34481d) Size: 0xf (15d)
	char pad_34481[15];
	// Offset: 0x86C0 (34496d)  Size: 0x4 (4d)	cache hud flags before we transform into demon, so we can go back to correct flags when we transform back
	int hudFlagsBeforeDemon;
	// Offset: 0x86c4 (34500d) Size: 0xebcc (60364d)
	char pad_34500[60364];
	// Offset: 0x17290 (94864d)  Size: 0xFA18 (64024d)	Dashboard ( Meters and timers for the player )
	idPlayerDashboard dashboard;
	// Offset: 0x26ca8 (158888d) Size: 0x8850 (34896d)
	char pad_158888[34896];
	// Offset: 0x2F4F8 (193784d)  Size: 0x8 (8d)	------------------------ player properties ------------------------ Extra definition data about the player
	idDeclPlayerProps* playerProps;
	// Offset: 0x2f500 (193792d) Size: 0x17dd0 (97744d)
	char pad_193792[97744];
	// Offset: 0x472D0 (291536d)  Size: 0x3F0 (1008d)	DO NOT call this directly. Use GetHUD() instead. Hud for the player.
	idHUD playerHud;
	// Offset: 0x476C0 (292544d) Size: 0x5C98 (23704d)
	char pad_End[23704];
}; // size: 0x4d358 (Size Dec: 316248)
static_assert(sizeof(idPlayer) == 316248, "Size of idPlayer is wrong !");
