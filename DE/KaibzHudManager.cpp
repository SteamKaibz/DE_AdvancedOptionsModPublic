...
std::string KaibzHudManager::getDdgStrForImgui()
{
	...
	oss << "Ptrs: idHUD_LowWarningPtr: " << idHUD_LowWarningPtr
		<< "  idHUD_AbilityIndicatorsPtr: " << idHUD_AbilityIndicatorsPtr
		<< " idHUD_ExtraLivesPtr: " << idHUD_ExtraLivesPtr
		<< " idHud_WeaponInfoPtr: " << idHud_WeaponInfoPtr
		<< " idHUD_HealthInfoPtr: " << idHUD_HealthInfoPtr
		<< " idHUD_BloodPunchPtr : " << idHUD_BloodPunchPtr;

	std::string ptrsInfoStr = oss.str();
	...
	//// Format the string using sprintf_s
	//std::sprintf_s(buffer, sizeof(buffer),
	//	"Ptrs: idHUD_LowWarningPtr: %p  idHUD_AbilityIndicatorsPtr: %p idHUD_ExtraLivesPtr: %p idHud_WeaponInfoPtr: %p idHUD_HealthInfoPtr: %p idHUD_BloodPunchPtr : %p",
