...
void modSettings::loadSettings()
{
    ...
    m_isLoadSettingsCalled = true; //! needed to check if we can set devMode or not
...
//    return m_devModeKeyStr == "667";
//}



//bool modSettings::isLoadSettingsCalled() {
//    return m_isLoadSettingsCalled;
//}
